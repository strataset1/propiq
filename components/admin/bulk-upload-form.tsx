          ...
          {entries.map((entry) => (
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <p className="text-white text-sm font-mono truncate flex-1">{entry.file.name}</p>
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {entry.status === "duplicate" && (
                    <span className="text-slate-400 text-xs">Already exists</span>
                  )}
                  {entry.status === "error" && (
                    <span className="text-red-400 text-xs">{entry.message}</span>
                  )}
                </div>
              </div>
